...
export const processStaffData = async (
  authToken: string,
  selectedFolders: { therapists: string; supervisors: string },
    ...
    for (const file of files) {
      try {
        ...
        if (headerRowIndex === -1) {
          ...
          throw new Error(`No valid headers found in file: ${file.name}.`);
        }
        ...
        throw new Error(`Error processing staff file (${file.name}): ${error}`);
      }
    }
